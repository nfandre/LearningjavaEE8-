...
public class PersonWriter {
    ...
    public String write() throws IOException {
        ...
        jsonObjectBuilder.add("emails", arrayBuilder);

        JsonObject jsonObject = jsonObjectBuilder.build();

        JsonWriterFactory writerFactory = createWriterFactory();
        return this.writerToString(jsonObject, writerFactory);
    }

    private String writerToString(JsonObject jsonObject, JsonWriterFactory writerFactory) throws IOException {
        String jsonString;
